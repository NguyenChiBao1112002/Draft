...
WebUI.delay(3)
WebUI.setEncryptedText(findTestObject('Object Repository/common/div/div_id_with_input_name', [('id'):'app', ('name'): 'password']), 'YsqIKzHWQwYX7jcwa8U8RQ==')
CustomKeywords.'common.UtilKeyword.takeScreenShot'("invalid_password_login")
...
if(WebUI.waitForElementVisible(findTestObject('Object Repository/common/div/div_class', [('class'): 'login-error']), 10)) {
	...
	CustomKeywords.'common.UtilKeyword.takeScreenShot'("invalid_pass_err_mess")
}else {
